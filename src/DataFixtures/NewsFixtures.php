...
class NewsFixtures extends Fixture
{
    const NEWS = [
        'La Tech été 2020' => [
            ...
            'description' => 'Cette année 2020 est longue en rebondissement, en passant par la pandemie,
             la crise sanitaire et bancaire, le secteur de la Tech reste tout de meme en expention,
              edit une conférence a Long Island sur la pérénité des association aux projets innovants.',
        ],
        'The buisness gate' => [
            'article' => 'Technologie et Buisness',
            'image' => 'https://www.telecomreview.info/images/stories/2017/09/news-28-09-06.jpg ',
            'description' => 'L\'inovation technologique touche à son paroxisme tout en offrant
             une possibilité grandissante d\'essort dans les domaines du Web et du Machine Learning',
        ],
        'Le futur du cellulaire' => [
            ...
            'description' => 'Les telephones sont de nos jours les outils les plus utilisés par chacun d\'entre nous.
             La télé travail ne fait qu\'augmenter le chiffre
              d\'affaire grandissant des grandes multinationales du mobile',
        ],
        'L\'essor du génie civil' => [
            ...
            'description' => 'Les grand chantiers de début 2020 ont du revoir tout leur plan d\'infrastructure.
             En effet, les nouvelles préconisations en terme de santé occasionnent
              de nouveaux test et soulèvent de nombreuses questions.'
        ],
        ...
        'Le geant Ubisoft' => [
            ...
            'description' => 'Cela fait maintenant quelque temps que le geant Ubisoft
             s\'est implanté au port de la lune. 
            Evidemment celui ci a permis de mettre la lumière sur le marché du développement en Gironde.'
        ],
        'Chantier Naval' => [
            'article' => 'Hissez haut',
            'image' =>
        ...
        'Samsung Coin' => [
            ...
            'description' => 'Le géant du high-tech va-t-il lancer sa propre cryptomonnaie ?
            En plus de ses gammes de smartphones,
             Samsung développe actuellement sa propre technologie blockchain. 
