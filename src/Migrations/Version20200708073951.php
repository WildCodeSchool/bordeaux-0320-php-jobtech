 ...
 */
final class Version20200708073951 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD contact_id INT NOT NULL, ADD is_new TINYINT(1) DEFAULT \'1\' NOT NULL, ADD is_to_contact TINYINT(1) DEFAULT \'0\' NOT NULL, DROP sender_id, DROP receiver_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD receiver_id INT NOT NULL, DROP is_new, DROP is_to_contact, CHANGE contact_id sender_id INT NOT NULL');
