 ...
 */
final class Version20200710083835 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, html LONGTEXT DEFAULT NULL, identifier VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE candidate (id INT AUTO_INCREMENT NOT NULL, gender_id INT NOT NULL, surname VARCHAR(45) NOT NULL, first_name VARCHAR(45) NOT NULL, birthday DATE NOT NULL, phone_number VARCHAR(20) NOT NULL, other_number VARCHAR(20) DEFAULT NULL, postal_code INT NOT NULL, city VARCHAR(60) NOT NULL, country VARCHAR(60) NOT NULL, is_handicapped TINYINT(1) DEFAULT \'0\' NOT NULL, is_contactable_tel TINYINT(1) DEFAULT \'0\' NOT NULL, is_contactable_email TINYINT(1) DEFAULT \'1\' NOT NULL, have_vehicle TINYINT(1) DEFAULT \'0\' NOT NULL, curriculum_vitae VARCHAR(255) NOT NULL, INDEX IDX_C8B28E44708A0E0 (gender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
